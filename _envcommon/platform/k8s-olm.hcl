...
dependency "ns" {
  config_path  = "${get_terragrunt_dir()}/../../platform/k8s-olm-ns/"
  skip_outputs = true
}
dependency "ns-operators" {
  config_path  = "${get_terragrunt_dir()}/../../platform/k8s-olm-operators-ns/"
  skip_outputs = true
}
# ---------------------------------------------------------------------------------------------------------------------
# MODULE PARAMETERS
...
inputs = {
  ...
  repository = "https://logscale-contrib.github.io/helm-olm"
